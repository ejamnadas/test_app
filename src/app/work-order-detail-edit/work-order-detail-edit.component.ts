...
@Component({
  selector: 'app-work-order-detail-edit',
  templateUrl: './work-order-detail-edit.component.html',
  styleUrls: ['./work-order-detail-edit.component.css']
})
export class WorkOrderDetailEditComponent implements OnInit {
  ...
  addWorkOrderNote(){
    let note = new WorkOrderNote(null, '', null);
